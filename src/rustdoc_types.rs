// Adapted from https://github.com/rust-lang/rust/blob/39d2f2affdd6b2856ab4b91359cc0d32b90bd26f/src/rustdoc-json-types/lib.rs#L39
...
pub struct ItemSummary {
    ...
    /// [`HashMap`][`std::collections::HashMap`] is `["std", "collections", "hash", "map",
    /// "HashMap"]`, but this is subject to change.
    pub path: Vec<String>,
